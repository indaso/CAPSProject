...
public class OldSurveyActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.hide();
        setContentView(R.layout.old_activity_survey);
        dBefore = new Date();
        ...
        startConversation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(OldSurveyActivity.this, GuidedActivity.class);
